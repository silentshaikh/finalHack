...
function SearchBar() {
  ...
  return (
    <form action='' onSubmit={onHandleSearchForm} className={`${poppins.className} flex items-center transition-all absolute ${navTogg ? 'max-[500px]:top-[350px]' : 'top-20'} ${searchTogg ? 'left-7 max-[450px]:left-3' : '-left-[400px]'} `}>
